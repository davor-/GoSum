...
Array<long double,Dynamic,1> CDynamicSystemRNG::prepare(unsigned int M)
{
    if ( M==0 ) throw "CDynamicSystemRNG::prepare: seed is zero";
...
CDynamicSystemRNG CRandomGenerator::ds;
CNomadRNG CRandomGenerator::mad;
CBaseRNG *CRandomGenerator::p=&CRandomGenerator::ds;
CRandomGenerator::rngtype CRandomGenerator::type=CRandomGenerator::dynamicsystem;
...
CRandomGenerator::rngtype CRandomGenerator::Type(std::string _stype)
{
    ...
    else if ( _stype=="dsample" )                return CRandomGenerator::dynamicsystem;
...
void CRandomGenerator::Set(rngtype _type,unsigned int s)
{
    ...
    else if ( _type==dynamicsystem )          SetDynamicSystem(s);
