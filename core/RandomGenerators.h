...
public:
    ...
    {   v=4101842887655102017LL; w=1;
        ...
        v = u;     int64();
        w = v;     int64();   }
    virtual unsigned int rndi() { return int64(); } //!< Returns randomly generated unsigned int.
...
public:
    ...
    virtual double rnd() { return double(rndi())/double(UINT32_MAX); } //!< Returns randomly generated double between 0 and 1.
};
...
public:
    enum rngtype {smallperiod, mediumperiod, nonlinearcongruential, largeperiod, dynamicsystem, nomads }; //!< Implemented RNG types.
...
private:
    ...
    static CDynamicSystemRNG ds; //!< Dynamic system RNG, static.
...
public:
    ...
    static void SetDynamicSystem(unsigned int s) { type=dynamicsystem; p=&ds; p->setSeed(s); } //!< Sets dynamic system RNG as active.
